...
S2.define('select2/i18n/en',[],function () {
  ...
  return {
    ...
    noResults: function ()
    {
        ...
        {
            if(window.lang['dir_misc_03'] !== undefined)
                return window.lang['dir_misc_03'];
        }

      return 'No results found'; // fallback
    },
    searching: function () {
      return 'Searching…';
    }
...
S2.define('select2/core',[
  ...
  Select2.prototype._placeContainer = function ($container) {
    ...
    var width = '100%'; //this._resolveWidth(this.$element, this.options.get('width'));
